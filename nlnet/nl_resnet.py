    ...
    def __init__(self,
        ...
        layers.append(
            block(
                ...
                **kwargs))
        if stage_index is 3:
            layers.append(NonLocal2d(out_channels))
...
class NLResNet(BaseBackbone):
    ...
    def init_weights(self, pretrained=None):
        super(NLResNet, self).init_weights(pretrained)
    ...
    def train(self, mode=True):
        super(NLResNet, self).train(mode)
        self._freeze_stages()
...
class NLResNetV1d(NLResNet):
    ...
    def __init__(self, **kwargs):
        super(NLResNetV1d, self).__init__(
